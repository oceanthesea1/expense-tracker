    ...
    <div>
      ...
      <div className="mt-3 border border-gray-300 rounded-lg overflow-hidden">
        ...
        {expensesList.map((expense, index) => (
          <div key={index} className="flex border-t p-3 gap-6 text-lg border-gray-300 hover:bg-gray-200 transition-all duration-200 ease-in-out">
            ...
            <div className="flex-1 flex gap-2">
              ...
              <Button className="cursor-pointer transform transition-all duration-200 ease-in-out hover:scale-105" variant='destructive' onClick = {() => deleteExpense(expense)}><Trash/> Delete</Button>
            </div>
          </div>
        ))}
      </div>
